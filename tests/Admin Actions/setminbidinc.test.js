...
test("set minimum bid increase", async () => {
    await atomicmarket.contract.setminbidinc({
...
test("throw when minimum bid increase is 0", async () => {
    await expect(atomicmarket.contract.setminbidinc({
        minimum_bid_increase: 0.0
    }, [{
        actor: atomicmarket.accountName,
        permission: "active"
...
test("throw when minimum bid increase is negative", async () => {
    await expect(atomicmarket.contract.setminbidinc({
